...
<footer class="footer">
    ...
    <div class="footer_grid">
        ...
        <nav class="footer_interes">
            <a href="/contacto" class="footer_interes-enlace">Contacto</a>
            <a href="/terminos" class="footer_interes-enlace">Terminos y Condiciones</a>
            <a href="/tratamiento" class="footer_interes-enlace">Politicas de tratamiento de datos</a>
        </nav>
    ...
    <p class="footer_copy"> 
        <span 
            class="footer_copy-regular">Todos los derechos reservados &copy;<?php echo date('Y'); ?> 
        </span>
        - AgroGestion
    </p>
