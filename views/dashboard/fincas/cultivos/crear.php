<?php
$descripcion = 'Vista para la creacion de un cultivo de la finca seleccionada';
?>
...
<main class=" dashboard cultivos_crud">
    ...
    <div class="contenido cultivos_crud_contenido">
        ...
        <div class="cultivos_crud_acciones cultivos_crud_botones">
            <a href="/dashboard/fincas/cultivos/index?id=<?php echo $finca->id; ?>" class=" lotes_crud_boton lotes_crud_volver">
