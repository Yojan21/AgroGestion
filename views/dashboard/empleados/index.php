...
<main class=" dashboard empleados">
    ...
    <div class="empleados_botones">
        <a href="/dashboard/empleados/crear" class="empleados_crear">
        ...
        <?php foreach($empleados as $empleado): ?>
            <div class="empleados_tag">
                ...
                <div class="empleados_acciones">
                    <a class="empleados_accion_botones empleados_accion-gestionar" href="/dashboard/empleados/perfil?id=<?php echo $empleado->id ?>">
                        <i class="fa-solid fa-circle-info"></i>
                    Mas info
                    </a>

                    <a class="empleados_accion_botones empleados_accion-editar" href="/dashboard/empleados/editar?id=<?php echo $empleado->id ?>">
                    ...
                    <form method="POST" action="/dashboard/empleados/eliminar" class="empleados_formulario">
                        ...
                        <button class="empleados_accion_botones empleados_accion-eliminar" type="submit">
